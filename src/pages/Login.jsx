...
const Login = () => {
  ...
  const handleLogin = async e => {
    ...
    try {
      // Llamada al servicio que consulta json-server
      const ok = await validateUser(username.trim(), password);
      if (ok) {
        // Cambia el estado global de auth y redirige
        login();
            ...
            <div className="p-8 md:p-12 relative z-10">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center mr-3 text-amarillo-concreto">
                    ✓
                  </div>
          ...
          <div className="flex-1 bg-fondo-hueso p-8 md:p-12">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="relative">
                <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-cielo">👤</div>
                <input
                  type="text"
                  value={username}
